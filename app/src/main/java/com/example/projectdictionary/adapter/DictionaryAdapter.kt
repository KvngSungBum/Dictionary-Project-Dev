...
class DictionaryAdapter(private val data: ArrayList<WordData>) : RecyclerView.Adapter<DictionaryAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DictionaryAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: DictionaryAdapter.ViewHolder, position: Int) {
